...
training_epochs = 2500 # total epochs for training
...
logger_params = {
    'log_file': {
        'desc': f"icam_tsp{min_problem_size}_to_{max_problem_size}_epoch{training_epochs}",
        'filename': 'run_log.txt',
        'filepath': './result_tsp_models/' + process_start_time.strftime("%Y%m%d_%H%M%S") + '{desc}'
    }
}
